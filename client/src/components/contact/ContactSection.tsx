      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Have a project in mind? Let's discuss how we can help bring your mobile app idea to life.
          </p>
        </div>
          ...
          <div className="lg:w-1/2 mt-12 lg:mt-0">
            <div className="bg-gray-50 p-8 rounded-xl h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  <Mail className="flex-shrink-0 h-6 w-6 text-primary mt-1" />
                  <div className="ml-3">
                    <h4 className="text-lg font-medium mb-1">Email Us</h4>
                    <p className="text-gray-600">
                      info@devcraftsolutions.com<br />
                      support@devcraftsolutions.com
                    </p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <Phone className="flex-shrink-0 h-6 w-6 text-primary mt-1" />
                  <div className="ml-3">
                ...
                <div className="flex items-start">
                  <Clock className="flex-shrink-0 h-6 w-6 text-primary mt-1" />
                  <div className="ml-3">
